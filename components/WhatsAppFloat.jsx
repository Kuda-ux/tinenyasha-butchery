  ...
  return (
    <div className="fixed bottom-5 right-5 z-50 flex flex-col items-end gap-3">
      <a
        ...
        className="flex items-center gap-2 rounded-full bg-[#1877F2] text-white px-4 py-3 shadow-soft hover:scale-105 transition-transform"
      >
      ...
      <a
        ...
        className="flex items-center gap-2 rounded-full bg-[#25D366] text-white px-4 py-3 shadow-soft hover:scale-105 transition-transform"
      >
